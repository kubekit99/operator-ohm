...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &openstackhelmv1alpha1.OpenstackUpgrade{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &openstackhelmv1alpha1.OpenstackUpgrade{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileOpenstackUpgrade) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &openstackhelmv1alpha1.OpenstackUpgrade{}
...
func newPodForCR(cr *openstackhelmv1alpha1.OpenstackUpgrade) *corev1.Pod {
