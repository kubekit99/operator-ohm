...
var log = logf.Log.WithName("controller_openstackbackup")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileOpenstackBackup{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &openstackhelmv1alpha1.OpenstackBackup{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &openstackhelmv1alpha1.OpenstackBackup{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileOpenstackBackup) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling OpenstackBackup")

	// Fetch the OpenstackBackup instance
	instance := &openstackhelmv1alpha1.OpenstackBackup{}
...
func newPodForCR(cr *openstackhelmv1alpha1.OpenstackBackup) *corev1.Pod {
