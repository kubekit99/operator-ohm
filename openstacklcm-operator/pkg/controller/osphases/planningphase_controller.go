...
func addPlanningPhase(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource (described in the yaml files) and requeue the owner PlanningPhase
...
// PlanningPhaseReconciler reconciles custom resources as Argo workflows.
...
// reconcilePlanningPhase reconciles the yaml files with the cluster
