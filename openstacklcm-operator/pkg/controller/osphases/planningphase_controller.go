...
import (
	...
	planningphasemgr "github.com/kubekit99/operator-ohm/openstacklcm-operator/pkg/osphases"
...
func newPlanningPhaseReconciler(mgr manager.Manager) reconcile.Reconciler {
	r := &PlanningPhaseReconciler{PhaseReconciler: PhaseReconciler{
...
func addPlanningPhase(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	dependentPredicate := crtpredicate.Funcs{
		...
		CreateFunc: func(e event.CreateEvent) bool {
			...
			planningphaselog.Info("CreateEvent. Filtering", "resource", o.GetName(), "namespace", o.GetNamespace(),
		...
		DeleteFunc: func(e event.DeleteEvent) bool {
			o := e.Object.(*unstructured.Unstructured)
			planningphaselog.Info("DeleteEvent. Triggering", "resource", o.GetName(), "namespace", o.GetNamespace(),
				"apiVersion", o.GroupVersionKind().GroupVersion(), "kind", o.GroupVersionKind().Kind)
			return true
		},
		...
		UpdateFunc: func(e event.UpdateEvent) bool {
			...
			if reflect.DeepEqual(old.Object, new.Object) {
				planningphaselog.Info("UpdateEvent. Filtering", "resource", new.GetName(), "namespace", new.GetNamespace(),
					"apiVersion", new.GroupVersionKind().GroupVersion(), "kind", new.GroupVersionKind().Kind)
				return false
			} else {
				planningphaselog.Info("UpdateEvent. Triggering", "resource", new.GetName(), "namespace", new.GetNamespace(),
					"apiVersion", new.GroupVersionKind().GroupVersion(), "kind", new.GroupVersionKind().Kind)
				return true
			}
		},
	...
	// Watch for changes to secondary resource (described in the helm chart) and requeue the owner PlanningPhase
...
// PlanningPhaseReconciler reconciles custom resources as Helm releases.
...
func (r *PlanningPhaseReconciler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
...
func (r PlanningPhaseReconciler) updateFinalizers(instance *av1.PlanningPhase) (bool, error) {
	...
	if !instance.IsDeleted() && !utils.FinalizerContainsString(pendingFinalizers, finalizerPlanningPhase) {
...
func (r PlanningPhaseReconciler) watchDependentResources(resource *av1.PlanningPhase) error {
...
func (r PlanningPhaseReconciler) deletePlanningPhase(mgr services.PlanningPhaseManager, instance *av1.PlanningPhase) (bool, error) {
	...
	pendingFinalizers := instance.GetFinalizers()
	if !utils.FinalizerContainsString(pendingFinalizers, finalizerPlanningPhase) {
...
// reconcilePlanningPhase reconciles the release with the cluster
...
// isReconcileDisabled
func (r PlanningPhaseReconciler) isReconcileDisabled(instance *av1.PlanningPhase) bool {
	...
	if instance.IsDisabled() {
		hrc := av1.LcmResourceCondition{
			...
			Status: av1.ConditionStatusFalse,
			Reason: "PlanningPhase is disabled",
		}
		r.recorder.Event(instance, corev1.EventTypeWarning, hrc.Type.String(), hrc.Reason.String())
		instance.Status.SetCondition(hrc, instance.Spec.TargetState)
		_ = r.updateResourceStatus(instance)
		...
		hrc := av1.LcmResourceCondition{
			Type:   av1.ConditionEnabled,
			Status: av1.ConditionStatusTrue,
			Reason: "PlanningPhase is enabled",
		}
		r.recorder.Event(instance, corev1.EventTypeNormal, hrc.Type.String(), hrc.Reason.String())
		instance.Status.SetCondition(hrc, instance.Spec.TargetState)
		return false
