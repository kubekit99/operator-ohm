...
func addOperationalPhase(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	dependentPredicate := crtpredicate.Funcs{
		...
		CreateFunc: func(e event.CreateEvent) bool {
			...
			operationalphaselog.Info("CreateEvent. Filtering", "resource", o.GetName(), "namespace", o.GetNamespace(),
		...
		DeleteFunc: func(e event.DeleteEvent) bool {
			o := e.Object.(*unstructured.Unstructured)
			operationalphaselog.Info("DeleteEvent. Triggering", "resource", o.GetName(), "namespace", o.GetNamespace(),
				"apiVersion", o.GroupVersionKind().GroupVersion(), "kind", o.GroupVersionKind().Kind)
			return true
		},
		...
		UpdateFunc: func(e event.UpdateEvent) bool {
			...
			if reflect.DeepEqual(old.Object, new.Object) {
				operationalphaselog.Info("UpdateEvent. Filtering", "resource", new.GetName(), "namespace", new.GetNamespace(),
					"apiVersion", new.GroupVersionKind().GroupVersion(), "kind", new.GroupVersionKind().Kind)
				return false
			} else {
				operationalphaselog.Info("UpdateEvent. Triggering", "resource", new.GetName(), "namespace", new.GetNamespace(),
					"apiVersion", new.GroupVersionKind().GroupVersion(), "kind", new.GroupVersionKind().Kind)
				return true
			}
		},
...
func (r *OperationalPhaseReconciler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
