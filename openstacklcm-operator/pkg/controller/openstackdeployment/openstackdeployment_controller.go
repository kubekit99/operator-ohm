...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileOpenstackDeployment{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &openstackhelmv1alpha1.OpenstackDeployment{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &openstackhelmv1alpha1.OpenstackDeployment{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileOpenstackDeployment) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling OpenstackDeployment")

	// Fetch the OpenstackDeployment instance
	instance := &openstackhelmv1alpha1.OpenstackDeployment{}
...
func newPodForCR(cr *openstackhelmv1alpha1.OpenstackDeployment) *corev1.Pod {
