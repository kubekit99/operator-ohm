...
var log5 = logf.Log.WithName("controller_openstackupgrade")
...
func AddOpenstackUpgrade(mgr manager.Manager) error {
	return add5(mgr, newReconciler5(mgr))
}

// newReconciler returns a new reconcile.Reconciler
func newReconciler5(mgr manager.Manager) reconcile.Reconciler {
...
func add5(mgr manager.Manager, r reconcile.Reconciler) error {
...
func (r *ReconcileOpenstackUpgrade) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log5.WithValues("OpenstackUpgrade.Namespace", request.Namespace, "OpenstackUpgrade.Name", request.Name)
...
func (r *ReconcileOpenstackUpgrade) updateStatus(instance *lcmv1alpha1.OpenstackUpgrade, success bool, reason string, openstackVersion string) error {
	...
	reqLogger := log5.WithValues("OpenstackUpgrade.Namespace", instance.Namespace, "OpenstackUpgrade.Name", instance.Name)
...
func (r *ReconcileOpenstackUpgrade) deleteWorkflow(wf *unstructured.Unstructured) error {
	...
	reqLogger := log5.WithValues("Worflow.Namespace", wf.GetNamespace(), "Worflow.Name", wf.GetName())
