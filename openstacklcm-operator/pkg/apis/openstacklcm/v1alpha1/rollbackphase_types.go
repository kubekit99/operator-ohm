...
func (obj *RollbackPhase) IsEnabled() bool {
...
func (obj *RollbackPhase) IsDisabled() bool {
...
func (obj *RollbackPhase) GetNotes() string {
	return "Notes"
}

func (obj *RollbackPhase) GetVersion() int32 {
