...
type TrafficRolloutPhaseSpec struct {
	...
	// be maintained in the TrafficRolloutPhase's revision history. The revision history
	// consists of all revisions not represented by a currently applied
	// TrafficRolloutPhaseSpec version. The default value is 10.
...
// +kubebuilder:resource:path=trafficrolloutphases,shortName=osvc
