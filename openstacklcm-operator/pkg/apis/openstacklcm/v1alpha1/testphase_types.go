...
type TestPhaseSpec struct {
	...
	// be maintained in the TestPhase's revision history. The revision history
	// consists of all revisions not represented by a currently applied
	// TestPhaseSpec version. The default value is 10.
...
// +kubebuilder:resource:path=testphases,shortName=osvc
