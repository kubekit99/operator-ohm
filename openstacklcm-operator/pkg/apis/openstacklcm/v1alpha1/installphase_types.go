...
type InstallPhaseSpec struct {
	...
	// be maintained in the InstallPhase's revision history. The revision history
	// consists of all revisions not represented by a currently applied
	// InstallPhaseSpec version. The default value is 10.
...
// +kubebuilder:resource:path=installphases,shortName=osvc
