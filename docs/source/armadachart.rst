...
The ArmadaChart defintion used in production is available here: `production <https://github.com/openstack/airship-armada/blob/master/armada/schemas/armada-chart-schema.yaml>`_
