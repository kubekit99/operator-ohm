# Greenfield and Uninstall OpenstackService Flow
...
## Greenfield OpenstackService Flow
...
## Uninstall OpenstackService Flow
...
prompt$ kubectl get all
NAME                                              READY   STATUS      RESTARTS   AGE
pod/keystone-armada-operator-5cfccc74fb-zc7kq     1/1     Running     0          39m
pod/keystone-oslc-operator-747bb84698-cqvb8       1/1     Running     0          39m
pod/mariadb-ingress-5cfc68b86f-g5qb5              1/1     Running     0          18m
pod/mariadb-ingress-error-pages-67c88c67d-tsdqd   1/1     Running     0          18m
pod/mariadb-server-0                              1/1     Running     0          18m
pod/memcached-memcached-75447bffcf-6mf27          1/1     Running     0          18m
pod/rabbitmq-cluster-wait-p59mk                   0/1     Completed   0          18m
pod/rabbitmq-rabbitmq-0                           1/1     Running     0          18m

NAME                                  TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)                        AGE
service/keystone-armada-operator      ClusterIP   10.102.35.39     <none>        8383/TCP                       39m
service/keystone-oslc-operator        ClusterIP   10.97.81.146     <none>        8383/TCP                       39m
service/kubernetes                    ClusterIP   10.96.0.1        <none>        443/TCP                        51m
service/mariadb                       ClusterIP   10.109.119.23    <none>        3306/TCP                       18m
...
service/mariadb-server                ClusterIP   10.104.200.51    <none>        3306/TCP                       18m
service/memcached                     ClusterIP   10.99.74.136     <none>        11211/TCP                      18m
service/rabbitmq                      ClusterIP   10.100.154.236   <none>        5672/TCP,25672/TCP,15672/TCP   18m
service/rabbitmq-dsv-7b1733           ClusterIP   None             <none>        5672/TCP,25672/TCP,15672/TCP   18m
service/rabbitmq-mgr-7b1733           ClusterIP   10.111.241.140   <none>        80/TCP,443/TCP                 18m

NAME                                          READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/keystone-armada-operator      1/1     1            1           39m
deployment.apps/keystone-oslc-operator        1/1     1            1           39m
deployment.apps/mariadb-ingress               1/1     1            1           18m
deployment.apps/mariadb-ingress-error-pages   1/1     1            1           18m
deployment.apps/memcached-memcached           1/1     1            1           18m

NAME                                                    DESIRED   CURRENT   READY   AGE
replicaset.apps/keystone-armada-operator-5cfccc74fb     1         1         1       39m
replicaset.apps/keystone-oslc-operator-747bb84698       1         1         1       39m
replicaset.apps/mariadb-ingress-5cfc68b86f              1         1         1       18m
replicaset.apps/mariadb-ingress-error-pages-67c88c67d   1         1         1       18m
replicaset.apps/memcached-memcached-75447bffcf          1         1         1       18m

NAME                                 READY   AGE
statefulset.apps/mariadb-server      1/1     18m
statefulset.apps/rabbitmq-rabbitmq   1/1     18m

NAME                              COMPLETIONS   DURATION   AGE
job.batch/rabbitmq-cluster-wait   1/1           32s        18m
```
...
prompt$ kubectl get all
NAME                                            READY   STATUS    RESTARTS   AGE
pod/keystone-armada-operator-5cfccc74fb-zc7kq   1/1     Running   0          40m
pod/keystone-oslc-operator-747bb84698-cqvb8     1/1     Running   0          40m

NAME                               TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)    AGE
service/keystone-armada-operator   ClusterIP   10.102.35.39   <none>        8383/TCP   40m
service/keystone-oslc-operator     ClusterIP   10.97.81.146   <none>        8383/TCP   40m
service/kubernetes                 ClusterIP   10.96.0.1      <none>        443/TCP    53m

NAME                                       READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/keystone-armada-operator   1/1     1            1           40m
deployment.apps/keystone-oslc-operator     1/1     1            1           40m
