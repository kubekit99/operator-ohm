...
prompt$ kubectl get all
NAME                                              READY   STATUS      RESTARTS   AGE
pod/keystone-api-6d7bd74f96-6s8qk                 1/1     Running     0          5m11s
pod/keystone-armada-operator-5cfccc74fb-zc7kq     1/1     Running     0          9m56s
pod/keystone-bootstrap-1692958623                 0/2     Completed   0          3m15s
pod/keystone-bootstrap-2032358733                 0/2     Completed   0          5m11s
pod/keystone-bootstrap-3637380442                 0/2     Completed   0          3m8s
pod/keystone-bootstrap-3824180533                 0/2     Completed   0          3m19s
pod/keystone-install-1608858220                   0/2     Completed   0          5m11s
pod/keystone-install-1630370687                   0/2     Completed   0          4m35s
pod/keystone-install-1659018021                   0/2     Completed   0          4m53s
pod/keystone-install-2012559777                   0/1     Completed   0          4m59s
pod/keystone-install-2401658373                   0/1     Completed   0          4m59s
pod/keystone-install-2716093231                   0/2     Completed   0          5m11s
pod/keystone-install-2958852122                   0/2     Completed   0          5m11s
pod/keystone-install-3754811077                   0/2     Completed   0          5m11s
pod/keystone-install-3843173896                   0/1     Completed   0          4m41s
pod/keystone-install-421213240                    0/2     Completed   0          5m11s
pod/keystone-install-4222398536                   0/1     Completed   0          4m41s
pod/keystone-install-494016497                    0/2     Completed   0          4m50s
pod/keystone-oslc-operator-747bb84698-cqvb8       1/1     Running     0          9m51s
pod/mariadb-ingress-5cfc68b86f-g7sgm              1/1     Running     0          7m38s
pod/mariadb-ingress-error-pages-67c88c67d-s5r7s   1/1     Running     0          7m39s
pod/mariadb-server-0                              1/1     Running     0          7m38s
pod/memcached-memcached-75447bffcf-bgxft          1/1     Running     0          7m37s
pod/rabbitmq-cluster-wait-ztvqh                   0/1     Completed   0          7m35s
pod/rabbitmq-rabbitmq-0                           1/1     Running     0          7m35s

NAME                                  TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)                        AGE
service/keystone                      ClusterIP   10.103.84.0      <none>        80/TCP,443/TCP                 5m11s
service/keystone-api                  ClusterIP   10.98.137.145    <none>        5000/TCP                       5m11s
service/keystone-armada-operator      ClusterIP   10.102.35.39     <none>        8383/TCP                       9m54s
service/keystone-oslc-operator        ClusterIP   10.97.81.146     <none>        8383/TCP                       9m49s
service/kubernetes                    ClusterIP   10.96.0.1        <none>        443/TCP                        22m
service/mariadb                       ClusterIP   10.98.4.164      <none>        3306/TCP                       7m39s
service/mariadb-discovery             ClusterIP   None             <none>        3306/TCP,4567/TCP              7m39s
service/mariadb-ingress-error-pages   ClusterIP   None             <none>        80/TCP                         7m39s
service/mariadb-server                ClusterIP   10.105.137.86    <none>        3306/TCP                       7m39s
service/memcached                     ClusterIP   10.100.216.105   <none>        11211/TCP                      7m37s
service/rabbitmq                      ClusterIP   10.98.191.40     <none>        5672/TCP,25672/TCP,15672/TCP   7m35s
service/rabbitmq-dsv-7b1733           ClusterIP   None             <none>        5672/TCP,25672/TCP,15672/TCP   7m35s
service/rabbitmq-mgr-7b1733           ClusterIP   10.97.20.244     <none>        80/TCP,443/TCP                 7m35s

NAME                                          READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/keystone-api                  1/1     1            1           5m11s
deployment.apps/keystone-armada-operator      1/1     1            1           9m57s
deployment.apps/keystone-oslc-operator        1/1     1            1           9m51s
deployment.apps/mariadb-ingress               1/1     1            1           7m39s
deployment.apps/mariadb-ingress-error-pages   1/1     1            1           7m39s
deployment.apps/memcached-memcached           1/1     1            1           7m37s

NAME                                                    DESIRED   CURRENT   READY   AGE
replicaset.apps/keystone-api-6d7bd74f96                 1         1         1       5m11s
replicaset.apps/keystone-armada-operator-5cfccc74fb     1         1         1       9m56s
replicaset.apps/keystone-oslc-operator-747bb84698       1         1         1       9m51s
replicaset.apps/mariadb-ingress-5cfc68b86f              1         1         1       7m39s
replicaset.apps/mariadb-ingress-error-pages-67c88c67d   1         1         1       7m39s
replicaset.apps/memcached-memcached-75447bffcf          1         1         1       7m37s

NAME                                 READY   AGE
statefulset.apps/mariadb-server      1/1     7m38s
statefulset.apps/rabbitmq-rabbitmq   1/1     7m35s

NAME                              COMPLETIONS   DURATION   AGE
job.batch/rabbitmq-cluster-wait   1/1           25s        7m35s

NAME                                       SCHEDULE       SUSPEND   ACTIVE   LAST SCHEDULE   AGE
cronjob.batch/keystone-credential-rotate   0 0 1 * *      False     0        <none>          5m11s
cronjob.batch/keystone-fernet-rotate       0 */12 * * *   False     0        <none>          5m11s
```
 
```bash
prompt$ kubectl delete -f examples/
argo/             brownfield/       git/              greenfield/       keystone/         lifecycle-events/ rollback/         sequenced/        uninstall/
```
 
```bash
prompt$ kubectl delete -f examples/keystone/keystone.yaml
armadachart.armada.airshipit.org "keystone" deleted
```
 
```bash
prompt$ kuebctl get all
...
prompt$ kubectl get all
NAME                                              READY   STATUS      RESTARTS   AGE
pod/keystone-armada-operator-5cfccc74fb-zc7kq     1/1     Running     0          11m
pod/keystone-oslc-operator-747bb84698-cqvb8       1/1     Running     0          11m
pod/mariadb-ingress-5cfc68b86f-g7sgm              1/1     Running     0          8m49s
pod/mariadb-ingress-error-pages-67c88c67d-s5r7s   1/1     Running     0          8m50s
pod/mariadb-server-0                              1/1     Running     0          8m49s
pod/memcached-memcached-75447bffcf-bgxft          1/1     Running     0          8m48s
pod/rabbitmq-cluster-wait-ztvqh                   0/1     Completed   0          8m46s
pod/rabbitmq-rabbitmq-0                           1/1     Running     0          8m46s

NAME                                  TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)                        AGE
service/keystone-armada-operator      ClusterIP   10.102.35.39     <none>        8383/TCP                       11m
service/keystone-oslc-operator        ClusterIP   10.97.81.146     <none>        8383/TCP                       11m
service/kubernetes                    ClusterIP   10.96.0.1        <none>        443/TCP                        23m
service/mariadb                       ClusterIP   10.98.4.164      <none>        3306/TCP                       8m50s
service/mariadb-discovery             ClusterIP   None             <none>        3306/TCP,4567/TCP              8m50s
service/mariadb-ingress-error-pages   ClusterIP   None             <none>        80/TCP                         8m50s
service/mariadb-server                ClusterIP   10.105.137.86    <none>        3306/TCP                       8m50s
service/memcached                     ClusterIP   10.100.216.105   <none>        11211/TCP                      8m48s
service/rabbitmq                      ClusterIP   10.98.191.40     <none>        5672/TCP,25672/TCP,15672/TCP   8m46s
service/rabbitmq-dsv-7b1733           ClusterIP   None             <none>        5672/TCP,25672/TCP,15672/TCP   8m46s
service/rabbitmq-mgr-7b1733           ClusterIP   10.97.20.244     <none>        80/TCP,443/TCP                 8m46s

NAME                                          READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/keystone-armada-operator      1/1     1            1           11m
deployment.apps/keystone-oslc-operator        1/1     1            1           11m
deployment.apps/mariadb-ingress               1/1     1            1           8m50s
deployment.apps/mariadb-ingress-error-pages   1/1     1            1           8m50s
deployment.apps/memcached-memcached           1/1     1            1           8m48s

NAME                                                    DESIRED   CURRENT   READY   AGE
replicaset.apps/keystone-armada-operator-5cfccc74fb     1         1         1       11m
replicaset.apps/keystone-oslc-operator-747bb84698       1         1         1       11m
replicaset.apps/mariadb-ingress-5cfc68b86f              1         1         1       8m50s
replicaset.apps/mariadb-ingress-error-pages-67c88c67d   1         1         1       8m50s
replicaset.apps/memcached-memcached-75447bffcf          1         1         1       8m48s

NAME                                 READY   AGE
statefulset.apps/mariadb-server      1/1     8m49s
statefulset.apps/rabbitmq-rabbitmq   1/1     8m46s

NAME                              COMPLETIONS   DURATION   AGE
job.batch/rabbitmq-cluster-wait   1/1           25s        8m46s
```
 
```bash
prompt$ kubectl getcrds
Error: unknown command "getcrds" for "kubectl"
Run 'kubectl --help' for usage.
unknown command "getcrds" for "kubectl"
```
...
```bash
prompt$ kubectl delete -f examples/keystone/
infra.yaml     keystone.yaml
```
 
```bash
prompt$ kubectl delete -f examples/keystone/infra.yaml
...
prompt$ kubectl get all
NAME                                            READY   STATUS    RESTARTS   AGE
pod/keystone-armada-operator-5cfccc74fb-zc7kq   1/1     Running   0          12m
pod/keystone-oslc-operator-747bb84698-cqvb8     1/1     Running   0          12m

NAME                               TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)    AGE
service/keystone-armada-operator   ClusterIP   10.102.35.39   <none>        8383/TCP   12m
service/keystone-oslc-operator     ClusterIP   10.97.81.146   <none>        8383/TCP   12m
service/kubernetes                 ClusterIP   10.96.0.1      <none>        443/TCP    25m

NAME                                       READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/keystone-armada-operator   1/1     1            1           13m
deployment.apps/keystone-oslc-operator     1/1     1            1           12m
