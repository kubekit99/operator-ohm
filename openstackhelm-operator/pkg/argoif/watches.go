...
type WorkflowWatchUpdater func(*wfv1.Workflow) error

// BuildWorkflowWatchUpdater builds a function that adds watches for resources in released Helm charts.
func BuildWorkflowWatchUpdater(mgr manager.Manager, owner *unstructured.Unstructured, c controller.Controller) WorkflowWatchUpdater {
	...
	dependentPredicate := crtpredicate.Funcs{
		...
		CreateFunc: func(e event.CreateEvent) bool {
			...
			log.Info("Skipping reconciliation for dependent workflow creation", "name", o.GetName(), "namespace", o.GetNamespace(), "apiVersion", o.GroupVersionKind().GroupVersion(), "kind", o.GroupVersionKind().Kind)
			return false
		},
		...
		DeleteFunc: func(e event.DeleteEvent) bool {
			o := e.Object.(*unstructured.Unstructured)
			log.Info("Reconciling due to dependent workflow deletion", "name", o.GetName(), "namespace", o.GetNamespace(), "apiVersion", o.GroupVersionKind().GroupVersion(), "kind", o.GroupVersionKind().Kind)
			return true
		},
		...
		UpdateFunc: func(e event.UpdateEvent) bool {
			...
			log.Info("Reconciling due to dependent workflow update", "name", new.GetName(), "namespace", new.GetNamespace(), "apiVersion", new.GroupVersionKind().GroupVersion(), "kind", new.GroupVersionKind().Kind)
			return true
		},
	}
	...
	releaseHook := func(release *wfv1.Workflow) error {
		for {
