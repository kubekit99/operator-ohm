...
func AddArmadaChartGroupController(mgr manager.Manager) error {
	...
	err = c.Watch(&source.Kind{Type: &armadav1alpha1.ArmadaChartGroup{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &armadav1alpha1.ArmadaChartGroup{},
	})
	if err != nil {
		return err
	}
...
func (r *ArmadaChartGroupReconciler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling ArmadaChartGroup")

	// Fetch the ArmadaChartGroup instance
	instance := &armadav1alpha1.ArmadaChartGroup{}
	...
	pod := newPodForCRToDelete2(instance)

	// Set ArmadaChartGroup instance as the owner and controller
...
func (r ArmadaChartGroupReconciler) updateResource(o *armadav1alpha1.ArmadaChartGroup) error {
	return r.client.Update(context.TODO(), o)
}

func (r ArmadaChartGroupReconciler) updateResourceStatus(instance *armadav1alpha1.ArmadaChartGroup, status *armadav1alpha1.ArmadaChartGroupStatus) error {
...
func newPodForCRToDelete2(cr *armadav1alpha1.ArmadaChartGroup) *corev1.Pod {
