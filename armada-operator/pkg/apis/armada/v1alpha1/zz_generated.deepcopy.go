...
func (in *ArmadaArmadaChart) DeepCopyInto(out *ArmadaArmadaChart) {
	*out = *in
	if in.Delete != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArmadaArmadaChart.
func (in *ArmadaArmadaChart) DeepCopy() *ArmadaArmadaChart {
	if in == nil {
		return nil
	}
	out := new(ArmadaArmadaChart)
	in.DeepCopyInto(out)
	return out
}
