...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AVDefaultPublic) DeepCopyInto(out *AVDefaultPublic) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AVDefaultPublic.
func (in *AVDefaultPublic) DeepCopy() *AVDefaultPublic {
	if in == nil {
		return nil
	}
	out := new(AVDefaultPublic)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AVEndpointTls) DeepCopyInto(out *AVEndpointTls) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AVEndpointTls.
func (in *AVEndpointTls) DeepCopy() *AVEndpointTls {
	if in == nil {
		return nil
	}
	out := new(AVEndpointTls)
...
func (in *AVEndpointType1) DeepCopyInto(out *AVEndpointType1) {
	*out = *in
	...
	if in.Port != nil {
		...
		*out = new(map[string]AVEndpointPort)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]AVEndpointPort, len(*in))
			for key, val := range *in {
				(*out)[key] = val
			}
		}
