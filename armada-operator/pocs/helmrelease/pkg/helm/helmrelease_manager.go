...
func (m helmreleasemanager) ReleaseName() string {
	return m.releaseName
}

func (m helmreleasemanager) IsInstalled() bool {
	return m.isInstalled
}

func (m helmreleasemanager) IsUpdateRequired() bool {
	return m.isUpdateRequired
}

// Sync ensures the Helm storage backend is in sync with the status of the
// custom resource.
func (m *helmreleasemanager) Sync(ctx context.Context) error {
...
func (m helmreleasemanager) syncReleaseStatus(status av1.HelmReleaseStatus) error {
...
func (m helmreleasemanager) loadChartAndConfig() (*cpb.Chart, *cpb.Config, error) {
...
func (m helmreleasemanager) getDeployedRelease() (*rpb.Release, error) {
...
func (m helmreleasemanager) getCandidateRelease(ctx context.Context, tiller *tiller.ReleaseServer, name string, chart *cpb.Chart, config *cpb.Config) (*rpb.Release, error) {
...
func (m helmreleasemanager) InstallRelease(ctx context.Context) (*rpb.Release, error) {
...
func (m helmreleasemanager) UpdateRelease(ctx context.Context) (*rpb.Release, *rpb.Release, error) {
...
func (m helmreleasemanager) ReconcileRelease(ctx context.Context) (*rpb.Release, error) {
...
func (m helmreleasemanager) UninstallRelease(ctx context.Context) (*rpb.Release, error) {
